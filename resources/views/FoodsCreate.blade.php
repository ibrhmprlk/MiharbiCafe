...
<main class="max-w-7xl mx-auto px-6 py-10 space-y-12">
  <!-- Header -->
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-3xl font-bold text-gray-800">Foods</h2>
        <a href="{{ route('foods') }}" class="text-sm font-medium text-green-600 hover:text-green-700 transition flex items-center">
            ← Back to Foods
        </a>
    </div>
        <!-- Form Card -->
        <div class="mt-10 bg-white rounded-2xl shadow-md p-6 sm:p-8">
            <form method="POST" action="{{ route('foods') }}" enctype="multipart/form-data">
                @csrf
