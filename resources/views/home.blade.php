...
<main class="max-w-7xl mx-auto px-4 sm:px-6 py-10">
    ...
    <section>
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-semibold">🥤 Drinks</h2>

            <!-- OK → DRINKS SAYFASI -->
            <a href="{{ route('drinksfoodsaboutmail.homeDrinks') }}"
   class="group text-sm font-medium text-blue-500 hover:text-blue-600
    ...
    @endif
                    ...
                    <div class="flex items-center justify-between mt-3 sm:mt-4 text-sm">
                        ...
                        <span class="font-semibold">{{ number_format($drink->price, 2, ',', '.') }} ₺</span>
                    </div>
                </div>
            @empty
                <p class="text-gray-400 italic col-span-full">No drinks found.</p>
            @endforelse
        </div>
   ...
   class="group text-sm font-medium text-blue-500 hover:text-blue-600
    ...
    @endif
                    ...
                    <div class="flex items-center justify-between mt-3 sm:mt-4 text-sm">
                        ...
                        <span class="font-semibold">{{ number_format($food->price, 2, ',', '.') }} ₺</span>
                    </div>
                </div>
            @empty
